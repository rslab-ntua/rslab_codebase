...
# #class_names gia TMF
# class_names = ['DUF','SUF','RAN','ICU','MES','PHT','GRN','BLF','CNF','DSV','SPSV','SVA','RCK','SND','WCR','WBD','MRS','VNY','FRT','CRL','CTN','GRF','OLG','MAZ','VEG','NGR','CWT']

#class_names gia TMG
class_names = ['DUF','SUF','RAN','ICU','MES','PHT','GRN','BLF','CNF','DSV','SPSV','SVA','RCK','SND','WCR','WBD','MRS','VNY','FRT']
...
for ratio in ratio_list:
    ...
    train_set, train_lab, other_set, other_lab = load_data_multi_samples(
    ...
    print ('... using  %2.0f'%(100*ratio),'%  of the data')
    ...
    TESTING
    '''
    print ('... testing on  %2.0f'%(100*(1-ratio) ),'%  of the data')
    ...
    fullpath = savepath+'CM_train_'+cube+'_'+ratio_string+'%.xlsx'
